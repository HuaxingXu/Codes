...
#define SLEEP_TIME 1000 //SLEEP_TIME = 1000000 为一秒
...
public:
    ...
    unsigned int send(char data[], unsigned int size);//发送数据
    unsigned int recv(char recv_buffer[], unsigned int max_recv_size);//接收数据
private:
